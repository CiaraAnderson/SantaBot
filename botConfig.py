...
botAvatar = "/static/santa.png" ##This can either be an image in your static folder or a web url to an image
chatBG = "/static/santapaper.jpg"  ##This can either be an image in your static folder or a web url to an image
